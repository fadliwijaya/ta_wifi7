...
int main(int argc, char *argv[]) {
  ...
  std::cout << "\n=======================================================\n";
  std::cout << "[INFO] Skenario Beban Maksimal / Stress Test (Wi-Fi 7)\n";
  std::cout << "=======================================================\n";
  std::cout << "Simulasi ini merupakan pengujian beban maksimal (stress test) yang dirancang untuk membombardir jaringan Wi-Fi 7 dengan volume lalu lintas data yang ekstrem, melebihi kapasitas standar harian. Tujuannya adalah untuk memicu antrean MAC yang panjang, potensi kemacetan (congestion), dan melihat batas kelumpuhan perangkat saat menangani throughput absolut tertinggi.\n\n";
  ...
  std::cout << "Dengan siksaan beban masif ini, kita dapat membongkar batas kritis maksimum gabungan dari AP Wi-Fi 7 dengan MLO, serta mengevaluasi seberapa efektif sistem penggabungan frame raksasa (A-MPDU Aggregation) dan lebar pita 320 MHz miliknya dalam menyedot data secara paralel di bawah tekanan ekstrem.\n";
  std::cout << "=======================================================\n";
