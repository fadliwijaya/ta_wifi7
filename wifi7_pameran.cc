...
int main(int argc, char *argv[]) {
  ...
  // Penyesuaian agar tidak terjadi drop queue yang besar, diset dekat batas maksimum PHY
  onoff.SetAttribute("DataRate", StringValue("9.5Gbps")); 
  ...
  for (auto const& stat : stats) {
      if (stat.first == 1) { 
          ...
          double spectralEfficiency = throughput / 320.0;

          std::string jsonOutput = "{\n";
          jsonOutput += "  \"Technology\": \"Wi-Fi 7\",\n";
          jsonOutput += "  \"MIMO\": \"8x8\",\n";
          jsonOutput += "  \"MLO\": \"ON\",\n";
          jsonOutput += "  \"QAM\": \"4096-QAM\",\n";
          jsonOutput += "  \"Channel Width\": \"320 MHz\",\n";
          ...
          std::ofstream outFile("scratch/Pameran/ns3_hasil_wifi7.json");
          outFile << jsonOutput;
          outFile.close();
      }
  }
