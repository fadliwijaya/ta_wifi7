...
int main(int argc, char *argv[]) {
  ...
  std::cout << "\n=======================================================\n";
  std::cout << "[INFO] Skenario Dasar / Baseline Clean Test dengan PCAP (Wi-Fi 7)\n";
  std::cout << "=======================================================\n";
  std::cout << "Simulasi ini merupakan skenario pengujian dasar (baseline/clean test) yang direkam secara penuh menggunakan Packet Capture (PCAP). Tujuannya adalah untuk mendirikan nilai acuan (baseline metrics) mengenai throughput, delay, jitter, dan stabilitas koneksi dalam kondisi normal sebelum diberikan beban pengujian ekstrem.\n\n";
  std::cout << "Secara konseptual, simulasi ini memodelkan dua ruangan terpisah yang masing-masing dilayani oleh satu buah Access Point (AP) Wi-Fi 7. Klien-klien didistribusikan ke dalam beberapa kelas dengan perilaku aktivitas internet campuran (heterogen), mulai dari penjelajahan web, streaming video 4K, hingga bermain game.\n\n";
  std::cout << "Skenario ini juga menerapkan profil mobilitas ganda: di mana klien di ruangan pertama akan berada pada posisi diam (statis), sementara klien di ruangan kedua bergerak dengan pola berjalan acak. Simulasi ini memberikan potret menyeluruh tentang kinerja Wi-Fi 7 di skenario harian (day-to-day) operasional jaringan.\n";
  std::cout << "=======================================================\n";
