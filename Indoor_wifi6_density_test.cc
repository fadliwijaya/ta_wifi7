...
int main(int argc, char *argv[]) {
    ...
    std::string logFileName = "scratch/ta_wifi7/output_simulasi/terminal_output_wifi6_density_" + timeStamp + ".log";
    std::string csvFileName = "scratch/ta_wifi7/output_simulasi/hasil_density_wifi6_" + timeStamp + ".csv";
