...
int main(int argc, char *argv[]) {
  ...
  std::string logFileName =
      "scratch/ta_wifi7/output_simulasi/terminal_output_wifi6_density_" +
      timeStamp + ".log";
  std::string csvFileName =
      "scratch/ta_wifi7/output_simulasi/hasil_density_wifi6_" + timeStamp +
      ".csv";
  ...
  std::cout << "=======================================================\n";
  std::cout << "[INFO] Skenario High-Density / Kepadatan User (Wi-Fi 6)\n";
  std::cout << "======================================================="
            << std::endl;
  ...
  std::cout
      << "Dengan pendekatan penambahan perangkat secara bertahap ini, kita "
         ...
         "concurrency) yang dapat ditangani oleh Access Point Wi-Fi 6.\n";
  std::cout << "=======================================================\n";
  std::cout << "[SPESIFIKASI SIMULASI]\n";
  std::cout << "- Standar Wi-Fi     : Wi-Fi 6 (802.11ax)\n";
  std::cout << "- Konfigurasi MIMO  : 8x8 Spatial Streams\n";
  std::cout << "- Fitur Spesial     : Single-Link (Non-MLO)\n";
  std::cout << "    * Link 0        : Frekuensi 5 GHz (Lebar Pita 160 MHz)\n";
  std::cout << "- Tx Power          : 20.0 dBm\n";
  std::cout << "- Rate Adaptation   : IdealWifiManager (Hingga 1024-QAM)\n";
  ...
  WifiMacHelper mac;
  Ssid ssid = Ssid("HighDensity-WiFi6");
